        ...
        >
          <motion.div variants={fadeIn}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8 mt-8">
              <motion.div 
                className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-primary transition-all duration-300 hover:shadow-md"
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">Sport Science (1st Class Honors)<br/>Full Stack Development (Code Institute)</p>
              </motion.div>
            </div>
            
            <h4 className="text-xl font-space font-bold mb-4 text-slate-800 dark:text-white">Skills & Technologies</h4>
          ...
          <div>
            <div className="flex mb-6 border-b border-slate-200 dark:border-slate-700">
              <button
                className={`py-2 px-4 font-medium transition-colors duration-200 text-lg ${
                  activeTab === 'all'
