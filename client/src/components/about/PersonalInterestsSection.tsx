...
const InterestCard: React.FC<InterestCardProps> = ({ 
  ...
  return (
    <motion.div
      className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md"
    ...
    >      {/* Background Image or Gradient */}
      ...
      <div className="relative z-10 p-6 h-full flex flex-col">
        ...
        {/* Description */}
        <p className="text-slate-700 dark:text-slate-300 text-sm mb-4 flex-grow leading-relaxed">
          {description}
        </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-slate-600 dark:text-slate-400 text-xs">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        )}
